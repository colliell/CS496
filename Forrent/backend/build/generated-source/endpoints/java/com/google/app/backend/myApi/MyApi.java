...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class CreateGroup extends MyApiRequest<com.google.app.backend.myApi.model.Response> {
    ...
    protected CreateGroup(java.lang.String groupName, java.lang.String pass) {
      super(MyApi.this, "POST", REST_PATH, null, com.google.app.backend.myApi.model.Response.class);
  ...
  public class CreateProp extends MyApiRequest<com.google.app.backend.myApi.model.PropEntity> {
  ...
  public class DeleteProp extends MyApiRequest<com.google.app.backend.myApi.model.Response> {
    ...
    protected DeleteProp(java.lang.String group, java.lang.String pass, java.lang.Long id) {
      super(MyApi.this, "DELETE", REST_PATH, null, com.google.app.backend.myApi.model.Response.class);
      this.group = com.google.api.client.util.Preconditions.checkNotNull(group, "Required parameter group must be specified.");
      this.pass = com.google.api.client.util.Preconditions.checkNotNull(pass, "Required parameter pass must be specified.");
  ...
  public class UpdateProp extends MyApiRequest<com.google.app.backend.myApi.model.Response> {

    private static final String REST_PATH = "response/{group}/{pass}/{id}/{timestamp}";
    ...
    protected UpdateProp(java.lang.String group, java.lang.String pass, java.lang.Long id, java.lang.Long timestamp, com.google.app.backend.myApi.model.JsonMap content) {
      super(MyApi.this, "PUT", REST_PATH, content, com.google.app.backend.myApi.model.Response.class);
      this.group = com.google.api.client.util.Preconditions.checkNotNull(group, "Required parameter group must be specified.");
      this.pass = com.google.api.client.util.Preconditions.checkNotNull(pass, "Required parameter pass must be specified.");
      this.id = com.google.api.client.util.Preconditions.checkNotNull(id, "Required parameter id must be specified.");
