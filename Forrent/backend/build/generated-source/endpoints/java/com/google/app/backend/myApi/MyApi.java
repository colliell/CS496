...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "createEntity".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link CreateEntity#execute()} method to invoke the remote operation.
   *
   * @param group
   * @param pass
   ...
   * @return the request
   */
  public CreateEntity createEntity(java.lang.String group, java.lang.String pass, com.google.app.backend.myApi.model.JsonMap content) throws java.io.IOException {
    CreateEntity result = new CreateEntity(group, pass, content);
    initialize(result);
    return result;
  }

  public class CreateEntity extends MyApiRequest<com.google.app.backend.myApi.model.PropEntity> {

    private static final String REST_PATH = "createEntity/{group}/{pass}";

    /**
     * Create a request for the method "createEntity".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link CreateEntity#execute()} method to invoke the remote operation. <p>
     * {@link
     * CreateEntity#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     ...
     * @since 1.13
     */
    protected CreateEntity(java.lang.String group, java.lang.String pass, com.google.app.backend.myApi.model.JsonMap content) {
      super(MyApi.this, "POST", REST_PATH, content, com.google.app.backend.myApi.model.PropEntity.class);
    ...
    @Override
    public CreateEntity setAlt(java.lang.String alt) {
      return (CreateEntity) super.setAlt(alt);
    }

    @Override
    public CreateEntity setFields(java.lang.String fields) {
      return (CreateEntity) super.setFields(fields);
    }

    @Override
    public CreateEntity setKey(java.lang.String key) {
      return (CreateEntity) super.setKey(key);
    }

    @Override
    public CreateEntity setOauthToken(java.lang.String oauthToken) {
      return (CreateEntity) super.setOauthToken(oauthToken);
    }

    @Override
    public CreateEntity setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (CreateEntity) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public CreateEntity setQuotaUser(java.lang.String quotaUser) {
      return (CreateEntity) super.setQuotaUser(quotaUser);
    }

    @Override
    public CreateEntity setUserIp(java.lang.String userIp) {
      return (CreateEntity) super.setUserIp(userIp);
    }
    ...
    public CreateEntity setGroup(java.lang.String group) {
      this.group = group;
      return this;
    }
    ...
    public CreateEntity setPass(java.lang.String pass) {
      this.pass = pass;
      return this;
    }

    @Override
    public CreateEntity set(String parameterName, Object value) {
      return (CreateEntity) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.google.app.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.google.app.backend.myApi.model.MyBean.class);
